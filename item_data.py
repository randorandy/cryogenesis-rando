...
items_unpackable: Iterable[Item] = (
    ...
    Items.HiJump, Items.DeepSuit, Items.Wave, Items.SpeedBooster, Items.Spazer,
    Items.Ice, Items.Grapple, Items.Plasma, Items.Screw, Items.Chrage,
    Items.SpaceJump, Items.Energy, Items.Meteorite
)
